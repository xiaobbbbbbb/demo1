...
public class ResponseData<T> {
     ...
     * @param enumCode
     */
    public void parserEnum(ResponseCode enumCode) {
    ...
    public static<T> ResponseData<T> success(T data) {
        ...
        responseData.parserEnum(ResponseCode.SUCCESS);
        // 放入响应数据
     ...
     */
    public static<T>  ResponseData<T> error(ResponseCode enumCode,T data) {
        // 创建响应标准格式对象
        ResponseData<T> responseData = new ResponseData<T>();
        // 调用转换器方法，将（错误）枚举常量解析。
